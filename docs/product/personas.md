...
## Persona 1 — The Obsessive Trip Architect
*Primary User*
...
**Frustrations:**
- OneNote is a flat blob — no way to search across content types or filter by attributes
- Half-formed ideas clutter the same space as fully-developed research
- No way to flag "this is a placeholder" vs "this is trip-ready"
...
## Persona 2 — The Co-Decider
*Indirect User — audience for the decision conversation*
...
**Frustrations:**
- Being shown cluttered notes or walls of bullet points is overwhelming
- Hard to get a feel for a place when the presentation feels like homework
- No easy way to compare options side by side

**How this product helps:**
- Presentation mode surfaces trip concept, sample itinerary, budget snapshot, and photos in a clean, scannable view
- Comparison view shows 2-3 shortlisted destinations side by side for a specific travel window
- Designed to require zero explanation to navigate — she can engage with it without being a user of the app
- Supports an honest decision conversation — not a sales pitch, but enough structured information to discuss tradeoffs naturally

**What she doesn't need:**
Editing, tagging, search, status indicators, or any of the power-user functionality — presentation mode is entirely read-only and stripped of app chrome.
